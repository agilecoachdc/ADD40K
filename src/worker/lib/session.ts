...
/** Un joueur ne peut modifier que sa propre fiche ; le MJ peut tout modifier. */
export function canEditCharacter(user: PublicUser, characterId: string): boolean {
  return user.role === "gm" || user.characterId === characterId;
}
